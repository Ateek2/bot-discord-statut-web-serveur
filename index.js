                    ...
                    tcpp.probe(addr2, port2, function (err, available1) {
                        tcpp.probe(addr3, port3, function (err, available2) {
                            tcpp.probe(
                                addr4,
                                port4,
                                function (err, available3) {
                                    tcpp.probe(
                                        addr5,
                                        port5,
                                        function (err, available4) {
                                            tcpp.ping(
                                                                            ...
                                                                            tcpp.ping(
                                                                                ...
                                                                                function (
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        var web = `${online} | [${nameweb0}](https://${addr}) (${Math.floor(
                                                                                            data.avg
                                                                                        )}ms)`;
                                                                                    } else {
                                                                                        var web = `${offline} | [${nameweb0}](https://${addr}) `;
                                                                                    }
                                                                                    if (
                                                                                        available1 ==
                                                                                        true
                                                                                    ) {
                                                                                        var web0 = `${online} | [${nameweb1}](https://${addr2}) (${Math.floor(
                                                                                            data2.avg
                                                                                        )}ms)`;
                                                                                    } else {
                                                                                        var web0 = `${offline} | [${nameweb1}](https://${addr2}) `;
                                                                                    }
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        var vps = `${online} | ${namevps0} (${Math.floor(
                                                                                            data3.avg
                                                                                        )}ms)`;
                                                                                    } else {
                                                                                        var vps = `${offline} | ${namevps0} `;
                                                                                    }
                                                                                    if (
                                                                                        available3 ==
                                                                                        true
                                                                                    ) {
                                                                                        var vps0 = `${online} | ${namevps2} (${Math.floor(
                                                                                            data4.avg
                                                                                        )}ms)`;
                                                                                    } else {
                                                                                        var vps0 = `${offline} | ${namevps2} `;
                                                                                    }
                                                                                    ...
                                                                                    if (
                                                                                        ...
                                                                                        var node = `${online} | ${namenode0} (${Math.floor(
                                                                                            data5.avg
                                                                                        )}ms)`;
                                                                                    } else {
                                                                                        var node = `${offline} | ${namenode0} `;
                                                                                    }

                                                                                    let ping =
                                                                                        new MessageEmbed()
                                                                                            .setTitle(
                                                                                                "Statut Des Infrastructure :"
                                                                                            )
                                                                                            .setColor(
                                                                                                ``
                                                                                            )
